...
export default function UsersPage() {
  ...
  // Filter out temporary users or ones generated by share link by default
  ...
  const filteredUsers = users.filter(u => {
    ...
    const matchesStatus = statusFilter === 'all' || (statusFilter === 'active' && !u.disabled) || (statusFilter === 'inactive' && u.disabled);
    
    if (!showTemporary) {
      if (u.temporary || u.name?.startsWith('Share:')) return false;
    }
      ...
      <div className="bg-white rounded-2xl p-4 border border-gray-200 shadow-sm flex flex-col sm:flex-row gap-4 mb-2">
        ...
        <div className="flex gap-4">
          ...
          <div className="relative">
            ...
            <label className="flex items-center gap-2 text-sm text-gray-600 font-medium cursor-pointer bg-gray-50 px-3 py-2.5 rounded-xl border border-transparent hover:border-gray-200 transition-all">
              <input 
                type="checkbox" 
